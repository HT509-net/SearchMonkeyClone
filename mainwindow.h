...
class MainWindow : public QMainWindow
{
  ...
  public:
    ...
    QStringList filterDateTime(
      const QStringList &files,
      const QDir &currentDir
    );

    QStringList filterSize(
      const QStringList &_files,
    ...
    // Change this
    inline bool modeEmptyDirs() {
      return false; /*ui->actionAdvanced->isChecked() && ui->emptyDirsCheckBox->isChecked();*/
    }
